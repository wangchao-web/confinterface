...
public abstract class ConfInterfacePublishService {
    ...
    public abstract void publishStatus(String account, String groupId, int status, List<MediaResource> forwardResources, List<MediaResource> reverseResources,String callMode);
